    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-1 lg:max-w-[12ch] reveal-up">
            Contact me for collaboration
          </h2>

          <p className="text-slate-300 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            Don't hesitate to get in touch with me and discuss your project
            needs, let's start creating together!
          </p>
          ...
          <div className="flex items-center gap-2 mt-auto reveal-up">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                href={href}
                target="_blank"
                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-slate-50/5 rounded-lg transition-[background-color,color] hover:bg-slate-50 hover:text-slate-800 active:bg-slate-50/80"
              >
                {icon}
              </a>
            ))}
        ...
        <form
          action="https://getform.io/f/broodlja"
          method="POST"
        ...
        >
          ...
          <div className="mb-4 reveal-up">
            ...
            <textarea
              ...
              placeholder="Hello!"
              required
              className="text-field resize-y min-h-32 max-h-80 max-wi"
            ></textarea>
          </div>

          <button
            type="submit"
            className="btn btn-download [&]:max-w-full w-full justify-center reveal-up"
          >
            Submit
          </button>
        </form>
